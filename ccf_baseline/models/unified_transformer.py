...
class UnifiedTransformer(Model):
    ...
    def __init__(self, args, place):
        ...
        if self.use_turn:
            ...
            self.turn_emb_name = "turn_embedding"
    ...
    def _gen_input(self,
        ...
        if self.use_turn:
            turn_emb_out = layers.embedding(
                input=turn_ids,
                size=[self.turn_type_size, self.emb_size],
                dtype=self.dtype,
                param_attr=fluid.ParamAttr(
                    name=self.turn_emb_name, initializer=self.param_initializer))
    ...
    def _generation_network(self,
        ...
        emb_out, n_head_self_attn_mask = self._gen_input(
            token_ids, type_ids, pos_ids, role_ids, turn_ids, generation_mask, aux_emb=aux_emb)
        return self._encode(
